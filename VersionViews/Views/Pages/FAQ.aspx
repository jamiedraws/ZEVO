            ...
            <ul class="faq__ul">
                <li>
                    ...
                    <div class="faq__answer">
                        <p><%= CampaignName %> Instant Action Sprays are new, safe (when used as directed. Always spray away from fish, birds and reptile) and powerful insect sprays that are tough on bugs, but safe for use around people and pets. <%= CampaignName %> Instant Action Sprays are different from traditional insect sprays because they use powerful essential oils to target nervous system receptors only active in insects and not people and pets. Our sprays come in crawling, flying, and stinging aerosol cans and a multi-insect trigger bottle.</p>
                    </div>
                </li>
                <li>
                    <button class="faq__question">
