        ...
        <fieldset class="steps c-brand--form__fieldset" id="productSelection">
            ...
            <div class="u-pad offer">
                <div class="offer__banner row">
                    ...
                    <div class="col offer__cta--dv">
                        <span>FREE SHIPPING!</span>
                    </div>
                </div>
                <div class="offer__banner offer__cta">
                    <span>Free Shipping</span>
                </div>
                ...
                <div class="offer__group">
                    <div class="offer__col">
                        ...
                        <div class="offer__item">
                            <h3><%= CampaignName %> Crawling Insect Spray.</h3>
                            <div class="row">
                                <div class="col item__offer">
                                ...
                                <div class="col">
                                    <img class="item__img" src="/images/3.0000/product-crawling-small.png?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= CampaignName %> available for crawling insects">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col--card">
                        <div class="offer__card">
                            <em>Free <small>Shipping</small></em>
                            <span>When You Order Now!</span>
                        </div>
                    </div>
                    <div class="offer__col">
                        <!-- Item -->
                        <div class="offer__item">
                            <h3><em class="offer__em">Best Value!</em> 3 Pack Bundle - $15.99</h3>
                            <div class="row">
                                <div class="col item__offer">
                                    <strong>How many would you like?</strong>
                                    <label class="row-to-center item__label">
                                ...
                                <div class="col">
                                    <img class="item__img" src="/images/3.0000/bundle-crawling-small.png?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= CampaignName %> available for flying insects">
                                </div>
                            </div>
                        </div>
                    </div>
