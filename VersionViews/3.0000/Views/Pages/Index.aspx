			...
			<div class="row atf">
				<div class="col-to-middle atf__offer">
					...
					<a href="#order" title="Order <%= CampaignName %> Now" class="atf__offer__img">
						<img src="/images/3.0000/main-offer-sm.png?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= CampaignName %> available for flying and crawling insects">
					</a>
				</div>
				<div class="col atf__media">
					<aside id="video" class="atf__aside" data-eflex-scale-vimeo-custom>
						<iframe id="video-video1199" src="https://player.vimeo.com/video/284009916?autoplay=0&title=0&byline=0&portrait=0" width="394" height="222" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
				...
				<div class="item detail__offer">
					<div class="row detail__product">
						<div class="col @sm-u-vw">
							<img class="product__shot" src="/images/3.0000/product-crawling-large.png?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= CampaignName %> crawling insect spray">
						</div>
						<div class="col @sm-u-vw product__detail">
							...
							<div class="product__img">
								<img src="/images/3.0000/crawling-insects.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Crawling insects">
							</div>
						</div>
					</div>
				</div>
	...
	<div id="how-it-works" class="section section--info">
		<div class="section__in">
			...
			<div class="nu-row info__group flex">
				<figure class="item">
					<img src="/images/3.0000/gfx-bugs.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Bugs">
					<h2>How It Works</h2>
					<p>You can feel good about using <%= CampaignName %> in your home because we understand what makes crawling and tick. Our bio-selective, DNA targeted formula quickly eliminates insects by using essential oils that target nervous system receptors only active in insects. That means you can use <%= CampaignName %> around your loved ones and pets without worry.*</p>
				</figure>
				...
				<div class="col @md-u-vw--25 graph__content">
					<div class="flex graph__content__in">
						...
						<div class="graph__product">
							<img class="graph__product__img" src="/images/3.0000/zevo-crawling.png?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= CampaignName %> crawling and flying">
						</div>
					</div>
				</div>
			</div>
	...
	<div id="reviews" class="section section--review gfx-primary">
		<div class="section__in review">
			...
			<div class="review__group nu-row grid">
				...
				<blockquote class="item review__item flex">
					<p><span>"Best Bug Spray Hands Down</span><span>I was seriously blown away by this bug spray! We live at the edge of some woods and always have ant and roach problems when the warm weather hits. This absolutely wiped them all away and I can't recommend this product enough!</span></p>
					<footer>
						<strong>Tamara R.</strong>
					</footer>
				</blockquote>
				<blockquote class="item review__item flex">
