			...
			<div class="row atf">
				<div class="col-to-middle atf__offer">
					...
					<a href="#order" title="Order <%= CampaignName %> Now" class="atf__offer__img">
						<%= Html.Partial("GetPaymentIcons") %>
						<img src="/images/4.0000/main-offer-sm.png?appV=<%= DtmContext.ApplicationVersion %>" alt="<%= CampaignName %> available for flying and crawling insects">
					</a>
				</div>
	...
	<div id="reviews" class="section section--review gfx-primary">
		<div class="section__in review">
			...
			<div class="review__group nu-row grid">
				...
				<blockquote class="item review__item flex">
					<p>"Best Bug Spray Hands Down I was seriously blown away by this bug spray! We live at the edge of some woods and always have ant and roach problems when the warm weather hits. This absolutely wiped them all away and I can't recommend this product enough!"</p>
					<footer>
